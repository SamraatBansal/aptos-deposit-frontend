...
const MainPage = () => {
  const publishedAddress = '0xe98036b5739443ad1267cc6a7ab9da94a2a56321bc71eb12d4dbebdb33816baf';
  ...
  const depositToken = useCallback(
    async (amount: String) => {
      ...
      const transaction = {
        type: 'entry_function_payload',
        function: `${publishedAddress}::SimpleVault::deposit`,
        arguments: [publishedAddress, amount],
        type_arguments: ['0x1::aptos_coin::AptosCoin']
      };
      const txnHash = await signAndSubmitTransaction(transaction);
      await aptosClient.waitForTransaction(txnHash.hash);
    },
